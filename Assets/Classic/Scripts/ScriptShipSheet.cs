...
public class Node
{
	...
	//Gameobject at this node in the grid, if any
	public bool isAdded = false;
	//True indicates this node has been checked off
	public bool isEmpty;
	//Whether a module exists in this node
	public int snakeIndex = -1;
	//Negative one for index indicates null value
	...
	public Node(Module scriptModuleArg)
	{
...
public class ScriptShipSheet : MonoBehaviour
{
	...
	protected ShipController scriptShipController;
	public List<Module> pilotContiguousModules;
	//Modules connected to first module


	//Scriptable
	static private int maxX = 50;
	//Max positive and negative x-value
	static private int maxY = 50;
	//Max positive and negative y-value
	private int minNodesForActivation = 3;
	//Number of contiguous modules required to form activation
	...
	void Start() {
		...
		//Acquire scripts
		scriptShipController = gameObject.GetComponent<ShipController>();
...
//		Debug.Log(scriptShipController.ModuleContainer.ToString());
	...
	public List<Module> GetModulesContiguousToPilot() {
		//Temporary variables
		pilotContiguousModules = new List<Module>();
		Module pilotModule = scriptShipController.PilotModule;
		...
		foreach (Module module in pilotContiguousModules) {
	...
	public Node GetNodeFromModule(Module module) {
		Vector2 nodeGridCoordinates = GetGridNodeCoordinates(module.moduleNodeCoordinates);
...
//			Node adjacentNode = schematic [(int)adjacentNodeCoordinates.x, (int)adjacentNodeCoordinates.y];
		...
		public void AddModuleToGrid (Module module, Vector2 schematicCoordinates)
		{
		...
		public void RemoveModuleFromGrid (Module module)
		{
				//Remove from grid
		...
		public void RemoveModuleFromSnake (Module module)
		{
		...
		public void DamageSnakeAtModule (Module module)
		{
